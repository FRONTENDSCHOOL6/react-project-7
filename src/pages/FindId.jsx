    ...
    <header className="bg-black pl-[70px] pt-[15px]">
      ...
      <div className="bg-black h-screen">
        <div className="pt-[70px] text-white login-title leading-10 container max-w-lg mx-auto align-middle">
          <div className="pb-[60px] font-bold text-2xl flex justify-center">아이디 찾기</div>
        <div className="text-white">
        이메일로 찾기
        가입 시 등록한 이메일을 입력해주세요</div>
        
        <input type="email" label="이메일" name="email" 
        className="h-14 bg-gray700 text-gray900 login-form px-4 w-full rounded-sm" 
        placeholder="이메일"/>
        
        <button type="submit" className="h-14 bg-gray600 text-white login-button w-full rounded-sm">확인</button>
        
        {/* <HorizonLine text="또는" /> */}
        <div className="bg-gray800 w-[30%] my-[1%] border-[1px]">
        ...
        <div>
          ...
          <button type="submit" className="h-14 bg-gray100 text-black font-semibold login-button w-full rounded-sm
